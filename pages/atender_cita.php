...
// 1. Importamos la clase de seguridad
...
if (isset($_POST['finalizar'])) {
    ...
    $diag = mysqli_real_escape_string($con, $_POST['diagnostico']);
    mysqli_query($con, "UPDATE cita SET diagnostico = '$diag', estado = 'Completada' WHERE id_cita = $id_cita");
    $mensaje = "✅ Diagnóstico guardado exitosamente.";
    $guardado = true;
}

// Consultar toda la información para el formulario
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <form method="POST">
                        ...
                        <textarea name="diagnostico" class="form-control mb-4" rows="12" placeholder="Escriba aquí los hallazgos médicos, vacunas aplicadas y receta..." required><?= htmlspecialchars($cita['diagnostico'] ?? '') ?></textarea>
